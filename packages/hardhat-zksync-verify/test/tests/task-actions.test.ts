...
// import * as service from '../../src/explorers/zksync-etherscan/service';
// import { ZkSyncVerifyPluginError } from '../../src/errors';

// describe('verifyContract etherscan', async function () {
//     beforeEach(() => {
//         sinon.stub(utils, 'retrieveContractBytecode').resolves('0x1234567890');
//         sinon.stub(metadata, 'inferSolcVersion').resolves('0.8.0');
//         sinon.stub(service.ZkSyncEtherscanExplorerService.prototype, 'getSolcVersion' as any).resolves(['0.8.0']);
...
//         sinon.stub(service.ZkSyncEtherscanExplorerService.prototype, 'getVerificationStatusWithRetry').resolves({
//             status: 200,
//             message: '1',
//             isOk: () => true,
//             isFailure: () => false,
...
//         sinon
//             .stub(service.ZkSyncEtherscanExplorerService.prototype, 'getVerificationStatusWithRetry')
//             .onFirstCall()

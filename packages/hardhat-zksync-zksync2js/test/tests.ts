    ...
    describe('successful-compilation artifact', async function () {
        ...
        describe('getImpersonatedSigner', function () {
            it.skip('should return the working impersonated signer', async function () {
                ...
                const impersonatedSigner = await this.env.zksync2js.getImpersonatedSigner(address);
        ...
        describe('wallet', function () {
            ...
            it('get specific wallet', async function () {
                const wallet = await this.env.zksync2js.getWallet(rich_wallets[6].privateKey);
            ...
            it.skip('should return the balance of the account', async function () {
                ...
                const [, secWallet] = await this.env.zksync2js.getWallets();

                assert.strictEqual(
                    await this.env.zksync2js.provider.getBalance(secWallet.address),
            ...
            it('should return the transaction count of the account', async function () {
                ...
                assert.strictEqual(await this.env.zksync2js.provider.getTransactionCount(secWallet), 0);
            });
        });
        ...
        describe('getContractFactory', function () {
            ...
            it('should return a contract factory', async function () {
                const artifact = await this.env.zksync2js.loadArtifact('Greeter');
                const contract = await this.env.zksync2js.getContractFactory(artifact.abi, artifact.bytecode);
        ...
        describe('getContractAt', function () {
            ...
            it('Should return an instance of a contract', async function () {
                const wallet = await this.env.zksync2js.getWallet();
                const contract = await this.env.zksync2js.getContractAt('Greeter', deployedGreeter.target.toString());
            ...
            it('Should return an instance of an interface', async function () {
                const wallet = await this.env.zksync2js.getWallet();
                const contract = await this.env.zksync2js.getContractAt('IGreeter', deployedGreeter.target.toString());
            ...
            it('Should be able to send txs and make calls', async function () {
                const greeter = await this.env.zksync2js.getContractAt('Greeter', deployedGreeter.target.toString());
    ...
    describe('wallets with accounts', async function () {
        describe('wallets with accounts strings', async function () {
            ...
            it('get invalid third wallet', async function () {
                try {
                    const wallet = await this.env.zksync2js.getWallet(3);
                } catch (err: any) {

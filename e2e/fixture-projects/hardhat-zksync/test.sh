...
pnpm install @openzeppelin/contracts@4.9.2
pnpm install @openzeppelin/contracts-upgradeable@4.9.2
pnpm install @matterlabs/hardhat-zksync
pnpm install hardhat@2.19.4
pnpm install @matterlabs/zksync-contracts
pnpm install typescript@5.1.6
pnpm install ts-node@10.6.0

pnpm hardhat deploy-zksync:contract --contract-name Greeter "Hi there!"
...
empty_output=$(pnpm hardhat deploy-zksync:contract --contract-name Empty --deployment-type create --no-compile 2>&1)

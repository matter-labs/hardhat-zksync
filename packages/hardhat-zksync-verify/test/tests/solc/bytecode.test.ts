...
describe("extractMatchingContractInformation", () => {
  it("should return null when the contract does not have 'evm' property", async () => {
    ...
    const result = await extractMatchingContractInformation(sourceName, contractName, buildInfo as any, deployedBytecode);
  ...
  it("should return the contract information when the bytecode is matched", async () => {
    ...
    const result = await bytecodes.extractMatchingContractInformation(sourceName, contractName, buildInfo as any, deployedBytecode);

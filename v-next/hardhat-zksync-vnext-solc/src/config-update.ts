import { SolcConfig, SolcUserConfig } from "@ignored/hardhat-vnext/types/config";
import { ZkSolcConfig } from "./types.js";
import { isBreakableCompilerVersion } from "./utils.js";
import { ZkSyncSolcPluginError } from "./errors.js";
import { COMPILERS_CONFLICT_ZKVM_SOLC } from "./constants.js";

...
import { ZkSyncSolcPluginError } from '../errors.js';
import { COMPILER_BINARY_CORRUPTION_ERROR, COMPILER_VERSION_INFO_FILE_NOT_FOUND_ERROR, COMPILER_VERSION_RANGE_ERROR, COMPILER_VERSION_WARNING, DEFAULT_COMPILER_VERSION_INFO_CACHE_PERIOD, DEFAULT_TIMEOUT_MILISECONDS, fallbackLatestZkSolcVersion, USER_AGENT, ZKSOLC_BIN_OWNER, ZKSOLC_BIN_REPOSITORY, ZKSOLC_BIN_REPOSITORY_NAME, ZKSOLC_COMPILER_PATH_VERSION, ZKSOLC_COMPILER_VERSION_MIN_VERSION } from '../constants.js';
import { download, getLatestRelease, getZksolcUrl, isURL, isVersionInRange, saltFromUrl, saveDataToFile } from '../utils.js';
...
export class ZksolcCompilerDownloader {
    ...
    public static compilerVersionInfoCachePeriodMs: number = DEFAULT_COMPILER_VERSION_INFO_CACHE_PERIOD;

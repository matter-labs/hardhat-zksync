...
//       const artifact1 = await deployer.loadArtifact("AnotherContract");
//       otherContract = await deployer.deploy(artifact1);

//       const artifact2 = await deployer.loadArtifact("Events");
//       contract = await deployer.deploy(artifact2, [otherContract.address]);

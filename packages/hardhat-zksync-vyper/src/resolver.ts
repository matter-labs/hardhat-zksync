...
export class Resolver {
    ...
    public resolveSourceName = async (sourceName: string): Promise<ResolvedFile> => {
...
`
    ...
    private async _resolveLocalSourceName(sourceName: string): Promise<ResolvedFile> {
    ...
    private async _resolveFile(sourceName: string, absolutePath: string): Promise<ResolvedFile> {
    ...
    private async _validateSourceNameExistenceAndCasing(fromDir: string, sourceName: string): Promise<void> {
        try {

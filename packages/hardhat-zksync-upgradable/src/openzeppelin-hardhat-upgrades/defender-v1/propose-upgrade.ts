...
import { getAdminClient, getNetwork } from '@openzeppelin/hardhat-upgrades/dist/defender-v1/utils';
import { UpgradeOptions } from '@openzeppelin/hardhat-upgrades/dist/utils/options';
    ...
    return async function proposeUpgrade(proxyAddress, contractNameOrImplFactory, opts = {}) {
        ...
        const verificationResponse =
            contractName && opts.bytecodeVerificationReferenceUrl
                ? await hre.defender.verifyDeployment(
                      newImplementation,
                      contractName,

...
export const COMPILE_AND_DEPLOY_LIBRARIES_INSTRUCTIONS = 'To compile and deploy libraries, please run: `yarn hardhat deploy:libraries --autopopulateConfig --privateKey <PRIVATE_KEY>`';

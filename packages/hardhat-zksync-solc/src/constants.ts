...
export const COMPILE_AND_DEPLOY_LIBRARIES_INSTRUCTIONS_DEPLOY =
    'To compile and deploy libraries, please run: `hardhat deploy-zksync:libraries`';
export const COMPILE_AND_DEPLOY_LIBRARIES_INSTRUCTIONS_ETHERS =
    'To compile and deploy libraries, run `hre.zksyncEthers.deployLibraries()` in the script to deploy the missing libraries before deploying the contracts.';
export const MISSING_LIBRARY_LINK_DEPLOY =
...
export const MISSING_LIBRARY_LINK_ETHERS =
    'For more details on how to use hre.zksyncEthers.deployLibraries() from hardhat-zksync-ethers plugin, visit: https://era.zksync.io/docs/tools/hardhat/hardhat-zksync-ethers.html.';

...
export const ZKSOLC_COMPILERS_SELECTOR_MAP: Record<string, string[]> = {
...
export const DEFAULT_COMPILER_VERSION_INFO_CACHE_PERIOD: number = 24 * 60 * 60 * 1000; // 24 hours
...
export const COMPILER_ZKSOLC_VERSION_WITH_ZKVM_SOLC_WARN: string = `zkVm (eraVersion) compiler is supported only with usage of zksolc version >= ${ZKSOLC_COMPILER_VERSION_MIN_VERSION_WITH_ZKVM_COMPILER}. Switching by default to the native solc compiler.`;
